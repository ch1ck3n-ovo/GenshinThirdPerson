...
public class GTPConfig implements ConfigData {
    ...
    @ConfigEntry.Gui.CollapsibleObject(startExpanded = true)
    public CameraAlignWhileClick cameraAlignWhileClick = new CameraAlignWhileClick();

    @ConfigEntry.Gui.CollapsibleObject(startExpanded = true)
    public CameraBasedMovement cameraBasedMovement = new CameraBasedMovement();

    @ConfigEntry.Gui.CollapsibleObject(startExpanded = true)
    public NoThirdPersonFrontView noThirdPersonFrontView = new NoThirdPersonFrontView();
    ...
    public static class CameraAlignWhileClick {
    ...
    public static class NoThirdPersonFrontView {
